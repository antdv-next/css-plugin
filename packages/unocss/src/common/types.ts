...
export interface BasePresetOptions {
  ...
  antPrefix?: string
  /**
   * @desc namespace 安全工具类使用的 token 前缀，如 bg-ant-primary 中的 'ant'。
   * 传 '' / undefined 可关闭这一模式。
   * @default 'ant'
   * @example tokenPrefix: 'antd' -> class="bg-antd-primary"
   */
  tokenPrefix?: string
}
